...
public class CSVWriter {
    ...
    public void writeStats(int day, int totalAnimals, double averageAge, int totalGrass, double totalKids, double totalEnergyOfLiving) throws IOException {
        writer.write(day + ",Zyjace zwierzoki: " + totalAnimals + ", sredni wiek niezyjacych: " + averageAge + ", liczba trawek: " + totalGrass + ", srednia dzieci: " + totalKids + ", srednia energia" + totalEnergyOfLiving + "\n");
    }
